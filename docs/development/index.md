...
```text
feature branch -> Testing -> main (Stable) -> v0.1.8
```
...
Semantic Version **0.1.8**; public documentation uses the **0.1** line.
...
immutable `v0.1.8` tag and matching artifacts. Repository owners must independently
