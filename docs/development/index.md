...
```text
feature branch -> Testing -> main (Stable) -> v0.1.6
```
...
Semantic Version **0.1.6**; public documentation uses the **0.1** line.
...
immutable `v0.1.6` tag and matching artifacts. Repository owners must independently
