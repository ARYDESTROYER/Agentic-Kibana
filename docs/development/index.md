...
```text
feature branch -> Testing -> main (Stable) -> v0.1.3
```
...
Semantic Version **0.1.3**; public documentation uses the **0.1** line.
...
immutable `v0.1.3` tag and matching artifacts. Repository owners must independently
