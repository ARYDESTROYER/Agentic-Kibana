...
```text
feature branch -> Testing -> main (Stable) -> v0.1.7
```
...
Semantic Version **0.1.7**; public documentation uses the **0.1** line.
...
immutable `v0.1.7` tag and matching artifacts. Repository owners must independently
