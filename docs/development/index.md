...
```text
feature branch -> Testing -> main (Stable) -> v0.1.9
```
...
Semantic Version **0.1.9**; public documentation uses the **0.1** line.
...
immutable `v0.1.9` tag and matching artifacts. Repository owners must independently
