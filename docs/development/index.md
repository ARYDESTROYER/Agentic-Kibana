...
```text
feature branch -> Testing -> main (Stable) -> v0.1.12
```
...
Semantic Version **0.1.12**; public documentation uses the **0.1** line.
...
immutable `v0.1.12` tag and matching signed/public artifacts. Repository owners
