...
This matrix describes application **0.1.3** and documentation line **0.1**. It
...
| Documentation | MkDocs Material; Mike history plus native GitHub Pages deployment | Every app serves its installed 0.1 guide at `/docs/0.1/`; the public selector uses `0.1`; packages/images use `0.1.3` |
...
Version 0.1 currently uses Semantic Version `0.1.3`. As a pre-1.0 product, it prioritizes
