...
the public HTTP surface in application version **0.1.7** and documentation line
...
Stable promotion both remain `0.1.7`; `TLSOC_RELEASE_CHANNEL` distinguishes
...
`capture_not_available_reason`; v0.1.7 reports capture unavailable rather than
