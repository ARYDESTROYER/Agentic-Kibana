...
| Variable | Meaning |
|---|---|
| `TLSOC_VERSION` | Compose image tag/build argument; must match the code's Semantic Version (`0.1.6`) |
...
its Stable promotion are application `0.1.6`. Promotion changes provenance/channel,
...
| State backend | Effective 0.1.6 behavior |
|---|---|
