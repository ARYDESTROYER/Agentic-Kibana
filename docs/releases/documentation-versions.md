...
- the full product SemVer, such as **0.1.8**; and
...
| --- | --- | --- | --- |
| 0.1 installed Testing guide | 0.1.8 | candidate commit on `Testing` | Testing |
...
| 0.1 installed 0.1.8 Stable guide | 0.1.8 | exact verified `main` commit after it is tagged `v0.1.8` and all signed/public artifacts plus updater runtime acceptance pass | Stable |
...
both report application version `0.1.8`; only accepted `main`/tag provenance may
