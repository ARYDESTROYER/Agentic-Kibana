...
> **Version 0.1.11 · `Testing` integration → `main` Stable**
...
Treat `v0.1.11` as installable only when its GitHub Release contains the canonical
...
it published no GitHub Release or installable signed plan. All seven are historical
and must not be used as deployment, bootstrap, or update sources; never move or
reuse their tags. Version 0.1.11 retains the writable
...
BuildKit's native platform and keeping the final runtime multi-platform. It makes no
