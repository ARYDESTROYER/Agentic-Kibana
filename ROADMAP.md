...
**Current baseline (Version `0.1.6`; `Testing` integration and default `main`
Stable source):** the canonical branches exist; 0.1.6 is a Stable release only when
the exact accepted commit has the immutable `v0.1.6` tag and matching signed/public
artifacts. The immutable `v0.1.4` and `v0.1.5` tags are historical and
non-installable because neither completed a canonical signed GitHub Release. Branch
...
**F. Ranked post-0.1.6 hardening sequence (release-gap audit, 2026-08-04):** keep the
0.1.6 Stable release focused on truthful UI, documentation, and release acceptance. The next
