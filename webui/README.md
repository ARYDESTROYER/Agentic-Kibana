...
pre-supervisor/source-built→v0.1.11 bootstrap, supported topology, lifecycle wrapper,
...
record and must never be used for bootstrap. Version 0.1.11 is actionable only after
...
The catalog is a future MCP/tooling input only; version 0.1.11 does not claim or ship
