...
v0.1.1→v0.1.10 bootstrap, supported topology, lifecycle wrapper, and post-success
...
The catalog is a future MCP/tooling input only; version 0.1.10 does not claim or ship
