...
v0.1.1→v0.1.6 bootstrap, supported topology, lifecycle wrapper, and post-success
...
The catalog is a future MCP/tooling input only; version 0.1.6 does not claim or ship
