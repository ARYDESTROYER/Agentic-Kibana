 ...
 * MCP server or network transport in version 0.1.5.
 */
export const DESIGN_SYSTEM_CATALOG = {
  ...
  futureAgentInterface: {
    ...
    transport: 'none',
    note: 'This serialisable catalog can back a future MCP resource/tool, but version 0.1.5 ships no MCP server.',
  },
} as const;
