...
Version 0.1.8 deliberately performs no automatic pruning. The updater state volume
...
supported online per-record cleanup command in v0.1.8; never edit the live volume's
