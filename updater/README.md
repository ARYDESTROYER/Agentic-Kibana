...
Version 0.1.6 deliberately performs no automatic pruning. The updater state volume
...
supported online per-record cleanup command in v0.1.6; never edit the live volume's
